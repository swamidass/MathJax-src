...
function NodeMixin(Base, options) {
    ...
    options = Options_js_1.userOptions(Options_js_1.defaultOptions({}, exports.NodeMixinOptions), options);
    return _a = (function (_super) {
            ...
            function NodeAdaptor() {
                ...
                _this.options = Options_js_1.userOptions(Options_js_1.defaultOptions({}, CLASS.OPTIONS), args[1]);
                return _this;
            }
